let paramsDefault = {
    ...
    optionsChat: {
        ...
        message:'Hola. Quisiera saber más acerca del sistema',
        phone:'+584127277391',
        text: 'Enviar'
    },
    optionsBot: {
...
function createElements(params) {
    ...
    <div class="whatsapp-widget-chat-header status" id="statusBot">En línea 🟢</div>
    </div>
    </div>
    </div>
    ...
    <input type="text" placeholder="Escribe un mensaje aquí" id="whatsapp-widget-chat-input" />                        
    </div>
